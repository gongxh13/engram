...
import type { SessionStatus, UserMessage, AssistantMessage, TextPart, ToolPart, AgentPart } from '@opencode-ai/sdk';
    ...
    event: async ({ event }) => {
      switch (event.type) {
        ...
        case 'message.part.updated': {
          const part = event.properties.part as TextPart | ToolPart | AgentPart;
